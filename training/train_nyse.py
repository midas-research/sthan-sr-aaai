...
from load_data_nyse import load_EOD_data, load_relation_data
...
class ReRaLSTM:
    ...
    def train(self):
        ...
        optimizer_hgat = optim.Adam(model.parameters(), 
                       ...
                       weight_decay=5e-4)
        inci_mat = np.load('hypergraph_nyse.npy')
        ...
        for i in range(self.epochs):
            ...
            for j in tqdm(range(self.valid_index - self.parameters['seq'] -self.steps +1)):
                ...
                cur_loss, cur_reg_loss, cur_rank_loss, curr_rr_train = trr_loss_mse_rank(output.reshape((1737,1)), torch.FloatTensor(price_batch).to(device), 
